...
Privileged-1层提供的服务接口，通过能力系统授权访问。以下服务均为**官方接口**，由项目维护。
...
以下服务计划开发，属于官方接口，遵循官方接口维护原则：

| 服务名称 | 端点范围 | 状态 | 维护方 |
|---------|---------|------|--------|
| 文件系统 | 0x7000-0x70FF | 计划中 | 项目维护者 |
| 网络栈 | 0x7100-0x71FF | 计划中 | 项目维护者 |
| 块设备 | 0x7200-0x72FF | 计划中 | 项目维护者 |
| 图形服务 | 0x7300-0x73FF | 计划中 | 项目维护者 |
| 音频服务 | 0x7400-0x74FF | 计划中 | 项目维护者 |
| AI服务 | 0x8000-0x80FF | 计划中 | 项目维护者 |
| 安全服务 | 0x8100-0x81FF | 计划中 | 项目维护者 |
...
- 项目维护者审核通过后，接口将从第三方范围移动到官方扩展服务范围
- 原第三方接口保留一段时间用于平滑迁移
...
| 范围 | 用途 | 类型 | 维护方 | 兼容性保证 |
|------|------|------|--------|----------|
| 0x0000-0x0FFF | Core-0系统调用 | 官方 | 项目维护者 | 只向后兼容 |
| 0x1000-0x1FFF | 能力管理器 | 官方 | 项目维护者 | 只向后兼容 |
| 0x2000-0x2FFF | 调度器 | 官方 | 项目维护者 | 只向后兼容 |
| 0x3000-0x3FFF | 内存管理器 | 官方 | 项目维护者 | 只向后兼容 |
| 0x4000-0x4FFF | 中断控制器 | 官方 | 项目维护者 | 只向后兼容 |
| 0x5000-0x5FFF | 系统调用分发 | 官方 | 项目维护者 | 只向后兼容 |
| 0x6000-0x6FFF | 模块管理器 | 官方 | 项目维护者 | 只向后兼容 |
| 0x7000-0x7FFF | 官方扩展服务 | 官方 | 项目维护者 | 只向后兼容 |
| 0x8000-0x8FFF | 官方高级服务 | 官方 | 项目维护者 | 只向后兼容 |
| 0x9000-0x9FFF | 第三方基础服务 | 第三方 | 各自开发者 | 不保证 |
| 0xA000-0xAFFF | 第三方高级服务 | 第三方 | 各自开发者 | 不保证 |
| 0xB000-0xFFFF | 保留 | 官方 | 项目维护者 | - |
