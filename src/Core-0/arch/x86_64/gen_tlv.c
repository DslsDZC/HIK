...
int main() {
    ...
    hdr[0] = BOOT_INFO_MAGIC;
    uint8_t *p = buf + 28;

    uint64_t kbase = 0x100000, ksize = 0x1000000, entry = 0x100000;
    uint32_t cpu = 1, arch = 1;
    mem_t mem[1] = {{0x100000, 0x01F00000, 1, 0}};  /* ~31MB usable RAM within 32MB identity map */
